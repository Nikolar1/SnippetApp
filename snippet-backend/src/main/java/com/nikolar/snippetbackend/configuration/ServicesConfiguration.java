...
public class ServicesConfiguration {
    private static final String PARSER_SERVICE_ADDRESS = "http://localhost:8083/";
    private static final String SEARCH_SERVICE_ADDRESS = "http://localhost:8082/";
    private static final String CLASSIFICATION_SERVICE_ADDRESS = "http://localhost:8081/";
    @Bean
